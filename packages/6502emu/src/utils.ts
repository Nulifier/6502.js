...
export function checkUint8(val: number): void {
	if (!STRICT) return;
...
export function checkInt8(val: number): void {
	if (!STRICT) return;
...
export function checkUint16(val: number): void {
	if (!STRICT) return;
...
export function checkInt16(val: number): void {
	if (!STRICT) return;
...
export function asHex(val: number, byteCount?: number, includePrefix = true): string {
